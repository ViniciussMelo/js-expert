import StringUtil from "@viniciussmelo/string-util";
...
// ?<year> -> to name a group, in this case group 1 will be year
// \d{4} -> get 4 digits
...
export default class DateUtil {
  ...
  static formatString(dateStr, currentFormat, expectedFormat) {
    ...
    if (!Object.keys(availableFormats).includes(expectedFormat)) {
      return { error: `the expectedFormat ${expectedFormat} is not available yet!` };
    }
